...
\begin{figure}[h!]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\linewidth]{Pictures/PVold}
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\linewidth]{Pictures/PVnewer}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{Pictures/Wind}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{Pictures/DCnano1}
...
\begin{figure}[h!]
	\centering
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\linewidth]{Pictures/inductive1}
	...
	%(or a blank line to force the subfigure onto a new line)
	\begin{subfigure}[b]{0.45\textwidth}
		\includegraphics[width=\linewidth]{Pictures/inductive2}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{Pictures/SST}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{Pictures/SSThypeTrain}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{Pictures/SST2}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{Pictures/MadeUp}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.7\linewidth]{Pictures/Quad}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\linewidth]{Pictures/TransformerStatus}
...
\begin{figure}[h!]
	\centering
	\includegraphics[height=0.5\textheight]{Pictures/Paralllel}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{Pictures/comparison}
